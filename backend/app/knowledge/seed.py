...
ENTRIES: list[dict[str, str]] = [
    ...
    },
    {
        ...
        "body": (
            ...
            "rather than just win rate. The five brackets are: "
            "Bracket 1 (Exhibition) — ultra-casual, theme/flavor first, "
            "no tutors, no fast mana, no game changers. Games go 12+ turns. "
            "Bracket 2 (Core) — average modern precon level, a small "
            "number of tutors (this tool treats 1-2 tutors as Bracket 2), "
            "no game changers, few if any 2-card combos. Games go "
            "9-12 turns. Bracket 3 (Upgraded) — tuned precon or custom "
            "deck, up to 3 game changer cards (or 3+ tutors), 2-card "
            "combos are late-game (turn 7+), no mass land denial. Games go "
            "7-9 turns. Bracket 4 (Optimized) — high power: 4+ game "
            "changers, OR mass land denial, OR a fast-combo profile (2+ "
            "game changers with a low curve and fast mana), heavy "
            "interaction, but stops short of cEDH meta. Games go 5-7 "
            "turns. Bracket 5 (cEDH) — "
            "competitive meta, fastest mana, compact win cons, Ad Nauseam "
            "and Underworld Breach lines. Games can end turn 2-4."
        ),
        "category": "power-level",
        "format": "commander",
    },
    {
        ...
        "body": (
            ...
            "matches deck cards against the EXACT list below (based on the "
            "official April 2025 Game Changers update). Only these names "
